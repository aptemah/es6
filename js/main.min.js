...
//Symbol используется для создания приватных свойств с уникальным именем и доступ к которым есть только через obj.Symbol()
	function symbol1() {
		var newObj = {};
		...
		newObj['zero'] = 'zero';
		newObj[symbolName1] = 'first';
		newObj[symbolName2] = 'second';
		newObj[symbolName1] = 'first rewrite';
  ...
  function arrow2() {
	var c = a.filter(function (item, index, array) {
	  return item == array[1];
	});
	console.log(c);
  }
